...
class PatchCore(torch.nn.Module):
    ...
    def load(
        ...
        nn_method=patchcore.common_pointCore.FaissNN(False, 4),
        basic_template=None,
        **kwargs,
    ):
        ...
        preadapt_aggregator = patchcore.common_pointCore.Aggregator(
        ...
        self.anomaly_scorer = patchcore.common_pointCore.NearestNeighbourScorer(
